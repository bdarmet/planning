package fr.ciag.caf.client.samples;
...
import fr.ciag.caf.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@fr.ciag.caf.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
